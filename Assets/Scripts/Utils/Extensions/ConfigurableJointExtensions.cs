...
public static class ConfigurableJointExtensions
{
    ...
    /// <summary>
    /// Turns on joint projection and sets the projection limits to zero. This means the joint will by projected
    ///  back to its constraint region, but will result in unrealistic movements of the bodies to satisfy this.
    ///  Good for connections which you want to be perfectly rigid.
    /// </summary>
    /// <param name="joint"></param>
    public static void EnableHardConstraints(this ConfigurableJoint joint)
    {
